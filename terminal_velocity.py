...
# Fall speed filters
drops_file = '/lcrc/group/earthscience/rjackson/twpdropsvdis/twpvdisdropsC3.b1.20120113*.cdf'
vdis_psd_file = '/lcrc/group/earthscience/rjackson/disdrometer/twpvdisC3.b1.*.cdf'
vdis_files = glob(vdis_psd_file)    
# Filtered data paths
filtered_file_path = '/lcrc/group/earthscience/rjackson/disdrometer/filtered/'
drops_file_prefix = '/lcrc/group/earthscience/rjackson/twpdropsvdis/twpvdisdropsC3.b1.'
