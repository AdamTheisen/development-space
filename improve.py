...
mapping = {
    ...
    'OC1f': {'name': 'carbon_organic_fraction_1_fine', 'long_name': 'Carbon, Organic Fraction 1 (Fine)',
             'comments': 'TOR, pure helium (>99.999%) atmosphere, temperature (T) = 140 °C', 'epa_code': '88324'},
    'OC2f': {'name': 'carbon_organic_fraction_2_fine', 'long_name': 'Carbon, Organic Fraction 2 (Fine)',
             'comments': 'TOR, pure helium (>99.999%) atmosphere, temperature (T) = 280 °C', 'epa_code': '88325'},
    'OC3f': {'name': 'carbon_organic_fraction_3_fine', 'long_name': 'Carbon, Organic Fraction 3 (Fine)',
             'comments': 'TOR, pure helium (>99.999%) atmosphere, temperature (T) = 480 °C', 'epa_code': '88326'},
    'OC4f': {'name': 'carbon_organic_fraction_4_fine', 'long_name': 'Carbon, Organic Fraction 4 (Fine)',
             'comments': 'TOR, pure helium (>99.999%) atmosphere, temperature (T) = 580 °C', 'epa_code': '88327'},
    'OPf': {'name': 'carbon_organic_reflectance_fine', 'long_name': 'Carbon, Organic Pyrolized (Fine) by Reflectance',
            ...
            'epa_code': '88328'},
    'OPTf': {'name': 'carbon_organic_transmittance_fine', 'long_name': 'Carbon, Organic Pyrolized (Fine) by Transmittance',
    ...
    'OCf': {'name': 'carbon_organic_total_fine', 'long_name': 'Carbon, Organic Total (Fine)',
            'comments': 'Organic carbon from TOR carbon fractions (OC1f+OC2f+OC3f+OC4f+OPf)', 'epa_code': '88320'},

    'EC1f': {'name': 'carbon_elemental_fraction_1_fine', 'long_name': 'Carbon, Elemental Fraction 1 (Fine)',
             'comments': 'TOR, 98% helium, 2% oxygen atmosphere, temperature (T) = 580° C.', 'epa_code': '88329'},
    'EC2f': {'name': 'carbon_elemental_fraction_2_fine', 'long_name': 'Carbon, Elemental Fraction 2 (Fine)',
             'comments': 'TOR, 98% helium, 2% oxygen atmosphere, temperature (T) = 740° C.', 'epa_code': '88380'},
    'EC3f': {'name': 'carbon_elemental_fraction_3_fine', 'long_name': 'Carbon, Elemental Fraction 3 (Fine)',
             'comments': 'TOR, 98% helium, 2% oxygen atmosphere, temperature (T) = 840° C.', 'epa_code': '88331'},
    'ECf': {'name': 'carbon_elemental_total_fine', 'long_name': 'Carbon, Elemental Total (Fine)',
            'comments': 'Elemental carbon from TOR carbon fractions (E1+E2+E3-OP)', 'epa_code': '88321'},

    'fAbs': {'name': 'filter_absorption_coeff', 'long_name': 'Filter Absorption Coefficient',
             ...
             'epa_code': '63102'},
    'FlowRate': {'name': 'flow_rate', 'long_name': 'Flow Rate',
                 'comments': 'The rate of air flow through an air sampling instrument', 'epa_code': '63102'},
    'MF': {'name': 'mass_pm2_5', 'long_name': 'Mass, PM2.5 (Fine)',
           'comments': 'Gravimetric mass measurement for particles with aerodynamic diameters less than 2.5 um',
           'epa_code': '88101'},
    'MT': {'name': 'mass_pm10', 'long_name': 'Mass, PM10 (Total)',
           'comments': 'Gravimetric mass measurement for particles with aerodynamic diameters less than 10 um',
           'epa_code': '85101'},
    'SampDur': {'name': 'sample_duration', 'long_name': 'Sampling Duration',
                'comments': 'The duration of a given sampling period in minutes'},

    'ammNO3f': {'name': 'ammonium_nitrate_fine', 'long_name': 'Ammonium Nitrate (Fine)',
                'comments': '1.29 x  NO3f'},
    'ammSO4f': {'name': 'ammonium_sulfate_fine', 'long_name': 'Ammonium Sulfate (Fine)',
                'comments': '1.375 x SO4f'},
    'OMCf': {'name': 'carbon_organic_mass_fine', 'long_name': 'Carbon, Organic Mass (fine)(1.8*OC)',
             'comments': '1.8 X OCf'},
    'TCf': {'name': 'carbon_total_fine', 'long_name': 'Carbon, Total (fine)',
            'comments': 'From TOR carbon fractions (OCf+ECf)'},
    'CM_calculated': {'name': 'CM_calculated', 'long_name': 'Mass, PM10-PM2.5 (Coarse)',
                      'comments': 'MT-MF'},
    'SeaSaltf': {'name': 'sea_salt_fine', 'long_name': 'Sea Salt (Fine)',
                 'comments': '1.8XCHLf'},
    'SOILf': {'name': 'soil_fine', 'long_name': 'Soil (Fine)',
              'comments': '2.2 × ALf + 2.49 × SIf + 1.63 × CAf + 2.42 × FEf + 1.94 × TIf'},
    'RCFM': {'name': 'mass_pm2_5_reconstructed', 'long_name': 'Mass, PM2.5 Reconstructed (Fine)',
             'comments': 'Sum of ammSO4f, ammNO3f, OMCf, ECf, soilf, and seasaltf.'},
    'RCTM': {'name': 'mass_pmi10_reconstructed', 'long_name': 'Mass, PM10 Reconstructed (Total)',
             'comments': 'Sum of ammSO4f, ammNO3f, OMCf, ECf, soilf, seasaltf, and CM_calculated.'},
}
laser_vars = {
    'RefF': {'units': 'ratio', 'comments': 'Final laser reflectance at ', 'name': 'final_laser_reflectance_'},
    'TransF': {'units': 'ratio', 'comments': 'Final laser transmittance at ', 'name': 'final_laser_transmittance_'},
    'RefI': {'units': 'ratio', 'comments': 'Initial laser reflectance at ', 'name': 'initial_laser_reflectance_'},
    'TransI': {'units': 'ratio', 'comments': 'Initial laser transmittance at ', 'name': 'initial_laser_transmittance_'},
    'RefM': {'units': 'ratio', 'comments': 'Minimum laser reflectance at ', 'name': 'min_laser_reflectance_'},
    'TransM': {'units': 'ratio', 'comments': ' Minimum laser transmittance at ', 'name': 'min_laser_transmittance_'},
    'OP_TR': {'units': 'ug m-3', 'comments': 'Organic Pyrolyzed Carbon by Reflectance at ',
              'name': 'organic_pyrolyzed_carbon_reflectance_'},
    'OP_TT': {'units': 'ug m-3', 'comments': 'Organic Pyrolyzed Carbon by Transmittance at ',
...
for v in laser_vars:
    for wl in laser_wl:
        ...
        if 'OP' not in v:
            mapping['_'.join([v, wl])] = {'units': laser_vars[v]['units'], 'name': name,
                                          'long_name': ' '.join([laser_vars[v]['comments'], wl])}
        else:
            var_name = wl.join(v.split('_'))
            mapping[var_name] = {'units': laser_vars[v]['units'], 'name': name,
                                 'long_name': ' '.join([laser_vars[v]['comments'], wl])}
...
datasets = []
ct = 0
attrs = {'url': url, 'site': np.unique(df.Site)[0]}
for v in variables:
    ...
    if ct == 0:
        ds = xr.Dataset(data_vars={mapping[v]['name']: (['time'], data, var_attrs)}, coords={'time': time}, attrs=attrs)
        ds['poc_' + mapping[v]['name']] = xr.DataArray(data=poc, dims=['time'], coords={'time': time}, attrs=poc_attrs)
        ct += 1
    else:
        ds[mapping[v]['name']] = xr.DataArray(data=data, dims=['time'], coords={'time': time}, attrs=var_attrs)
        ds['poc_' + mapping[v]['name']] = xr.DataArray(data=poc, dims=['time'], coords={'time': time}, attrs=poc_attrs)

ds.to_netcdf('improve.nc')
ds.to_dataframe().to_csv('improve.csv')
