...
files = glob.glob('./guctsiskycoverM1.b1/*')
files.sort()
...
obj2 = obj2.where(obj2['qc_wspd_vec_mean'] == 0)
...
display.plot_data('wdir_vec_mean', 'wspd_vec_mean', 'percent_thin', num_dirs=24, plot_type='contour', contour_type='mean', num_data_bins=10, clevels=21, cmap='rainbow')
