...
display.plot_data('wdir_vec_mean', 'wspd_vec_mean', 'first_cbh', num_dirs=24, plot_type='contour', contour_type='mean', num_data_bins=10, clevels=21, cmap='rainbow')
