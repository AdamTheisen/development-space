...
# Read in Data
obj = act.io.armfiles.read_netcdf('./sgpmfrsr7nchE11.b1/sgpmfrsr7nchE11.b1.20210329.070000.nc')
...
obj.qcfilter.add_greater_test(variable, 0.4, test_meaning='Value is greater than 0.4 W/m2')
