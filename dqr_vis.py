...
obj = act.qc.arm.add_dqr_to_qc(obj, variable=variable, dqr_link=True)
...
obj.qcfilter.datafilter(variable, rm_assessments=['Bad'], del_qc_var=False)

print(obj[variable].attrs['history'])

obj.write.write_netcdf(path='./dqr_test.nc')
